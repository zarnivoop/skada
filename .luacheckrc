...
globals = {
    ...
    "DEFAULT_CHAT_FRAME", "UnitThreatSituation", "WorldFrame", "AceGUIWidgetLSMlists",
    "ChatEdit_GetActiveWindow", "ChatEdit_InsertLink", "ChatFrame_OpenChat",
    "CreateFont", "RAID_CLASS_COLORS", "ElvUI",
    ...
    "IsInGroup", "SecondsToTimeAbbrev", "date", "UpdateAddOnCPUUsage", "GetFunctionCPUUsage",
