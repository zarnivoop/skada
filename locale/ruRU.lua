...
L["Hide line numbers"] = "Скрыть номера строк"
L["Hide rank numbers on bars."] = "Скрыть номера рангов на полосах."
...
L["Mana gain spell list"] = "Способности дающие ману"
...
L["reports the active mode"] = "отчет активного режима"
L["Reset"] = "Сброс"
...
L["TotalHealing"] = "Всего Исцеления"
L["TPS"] = "УгВС"
L["Tweaks"] = "Настройки"
...
L["Show Version History"] = "Показать историю версий"
...
-- Broker Display
L["Data text"] = "Текстовые данные"
L["Data text acts as an LDB data feed. It can be integrated in any LDB display such as Titan Panel or ChocolateBar. It also has an optional internal frame."] = "Текстовые данные действуют как канал данных LDB. Они могут быть интегрированы в любой LDB-дисплей, такой как Titan Panel или ChocolateBar. Также имеет дополнительную внутреннюю рамку."
L["Hint: Left-Click to set active mode."] = "Подсказка: Левый клик для установки активного режима."
L["Right-click to set active set."] = "Правый клик для установки активного набора."
L["Shift + Left-Click to open menu."] = "Shift + Левый клик для открытия меню."
L["Class color text"] = "Текст цвета класса"
L["When possible, bar text will be colored according to player class."] = "Когда возможно, текст будет окрашен в соответствии с классом игрока."
L["Text color"] = "Цвет текста"
L["Choose the default color."] = "Выберите цвет по умолчанию."
L["Font flags"] = "Флаги шрифта"
L["Sets the font flags."] = "Устанавливает флаги шрифта."
L["None"] = "Нет"
L["Outline"] = "Контур"
L["Thick outline"] = "Толстый контур"
L["Monochrome"] = "Монохромный"
L["Outlined monochrome"] = "Монохромный с контуром"

-- Death Log
L["Death log"] = "Журнал смертей"
L["Show death log"] = "Показать журнал смертей"
L["Time relative to fight start."] = "Время относительно начала боя."
