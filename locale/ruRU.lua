...
L["%s dies"] = "%s умирает"
L["%s on %s removed by %s"] = "%s на %s удалeны %s"
L["%s on %s removed by %s's %s"] = "%s на %s удалены %s's %s"
L["A damage meter."] = "Измеритель урона."
L["Absorb"] = "Поглощение"
L["Absorb details"] = "Детали поглощения"
L["Absorb spells"] = "Заклинания поглощения"
...
L["Boss fights will be kept with this on, and non-boss fights are discarded."] = "При включении этой опции бои с боссами будут сохраняться, а бои с мобами будут игнорироваться."
L["Broker display"] = "Отображение брокера"
...
L["Choose which data feed to show in the DataBroker view. This requires an LDB display addon, such as Titan Panel."] = "Выберите, какие данные выводить в DataBroker. Для этого требуется модификация, которая поддерживает отображение LDB, например Titan Panel."
...
L["Create %s window"] = "Создать окно %s"
L["Create Windows"] = "Создать окна"
L["Create bar window"] = "Создать окно панели"
L["Create broker window"] = "Создать окно брокера"
L["Create inline window"] = "Создать встроенное окно"
...
L["Display the version history using the notification system."] = "Отображение истории версий с помощью системы уведомлений."
L["Distance between bars."] = "Расстояние между полосами"
L["Do not show DPS"] = "Не показывать УВС"
L["Do not show HPS"] = "Не отображать ИВС"
L["Do not show TPS"] = "Не показывать УгВС"
L["Do not warn while tanking"] = "Не оповещать при танковании"
...
L["Energy gain sources"] = "Источники получения энергии"
L["Energy gained"] = "Получено энергии"
L["Enter the name for the new window."] = "Введите название нового окна."
L["Enter the name for the window."] = "Введите новое название для окна."
L["Enter the name for the new %s display window."] = "Введите название для нового окна отображения %s"
L["Enter the name for the new window with the selected display system."] = "Введите название для нового окна с выбранной системой отображения."
L["Evade"] = "Уклонение"
L["Fails"] = "Неудачи"
L["Fixed bar width"] = "Фиксированная ширина полос"
L["Flash screen"] = "Мигание экрана"
L["Focus gain sources"] = "Источники получения концентрации"
L["Focus gained"] = "Получено концентрации"
L["Font flags"] = "Флаги шрифта"
L["Friendly Fire"] = "Дружественный огонь"
L["Fury gain sources"] = "Источники получения ярости"
L["Fury gained"] = "Получено ярости"
L["General"] = "Общие"
L["General options"] = "Основные настройки"
L["Glancing"] = "Вскользь"
L["Guild"] = "Гильдия"
L["Healed by"] = "Исцеление от"
L["Healed players"] = "Исцелённые игроки"
L["Healing"] = "Исцеление"
L["Healing: Personal HPS"] = "Исцеление: Персональный ИВС"
L["Healing: Raid HPS"] = "Исцеление: Рейдовый ИВС"
...
L["Hides HPS from the Healing modes."] = "Скрыть ИВС (HPS) в режиме исцеления."
...
L["Hint: Left-Click to toggle Skada window."] = "Подсказка: ЛКМ открывает/закрывает окно Skada."
L["Hit"] = "Попадание"
L["Holy power gain sources"] = "Источники получения энергии света"
L["Holy power gained"] = "Получено энергии света"
L["How often windows are updated. Shorter for faster updates. Increases CPU usage."] = "Частота обновления окон. Меньшее значение способствует более быстрому обновлению. Увеличивает нагрузку на процессор."
L["HPS"] = "ИВС"
...
L["Ignore Main Tanks"] = "Игнорировать основных танков"
L["Immune"] = "Невоспр."
...
L["List of players damaged"] = "Список игроков, получивших урон"
L["Lock window"] = "Заблокировать окно"
L["Locks the bar window in place."] = "Зафиксировать окно"
L["Mana gain spell list"] = "Способности получения маны"
...
L["Missed"] = "Промах"
L["Mode"] = "Режим"
L["Mode description"] = "Описание режима"
...
L["Other"] = "Другое"
L["Outline"] = "Контур"
L["Outlined monochrome"] = "Монохромный контур"
L["Overheal"] = "Переисцеление"
L["Overhealing"] = "Избыточное лечение"
L["Overhealing spells"] = "Заклинания избыточного исцеления"
L["Pain gain sources"] = "Источники получения боли"
L["Pain gained"] = "Получение боли"
L["Parry"] = "Парир."
L["Party"] = "Группа"
L["Percent"] = "Процент"
...
L["Power"] = "Энергия"
L["Power gains"] = "Получено энергии"
L["Profiles"] = "Профили"
L["Rage gain sources"] = "Источники получения ярости"
L["Rage gained"] = "Получено ярости"
L["Raid"] = "Рейд"
L["RDPS"] = "РУВС"
L["RealID"] = "RealID"
L["Reflect"] = "Отражение"
...
L["Report"] = "Отчет"
L["Report description"] = "Открыть окно для отправки данных отчета другим игрокам различными способами."
L["Reset"] = "Сброс"
...
L["Reset on leaving a group"] = "Сбрасывать при выходе из группы"
...
L["Right-click to set active set."] = "ПКМ - установить активный набор."
L["Role icons"] = "Иконки ролей"
L["Runic power gain sources"] = "Источники получения силы рун"
L["Runic power gained"] = "Получено силы рун"
L["'s "] = " - "
...
L["Scale"] = "Масштаб"
L["Segment"] = "Сегмент"
L["Segment description"] = "Описание сегмента"
...
L["Show Version History"] = "Показывать историю версий"
L["Show menu button"] = "Показывать кнопку меню"
L["Show minimap button"] = "Показывать кнопку у миникарты"
L["Show rank numbers"] = "Показывать номера рангов"
L["Show raw threat"] = "Показывать чистую угрозу"
L["Show spark effect"] = "Показывать эффект искры"
L["Show tooltips"] = "Показывать подсказки"
L["Show totals"] = "Показывать итог"
L["Shows a button for opening the menu in the window title bar."] = "Отображение кнопки для открытия меню в строке заголовка."
...
L["Shows damage done on players by friendly players."] = "Показывает урон, нанесенный игрокам дружественными игроками."
L["Shows numbers for relative ranks for modes where it is applicable."] = "Показывает числа для относительных рангов для режимов, где это применимо."
L["Shows raw threat percentage relative to tank instead of modified for range."] = "Показывает чистый процент угрозы относительно танка, а не измененный с учетом дальности."
...
L["Snap to best fit"] = "Привязка размера"
...
L["Soul Shards gain sources"] = "Источники получения Осколков Души"
L["Soul Shards gained"] = "Получено Осколков Души"
...
L["Switch to mode"] = "Сменить режим"
L["Switch to segment"] = "Сменить сегмент"
L["targets"] = "цели"
...
L["The font used by all bars."] = "Шрифт, используемый для полос."
L["The height of the bars."] = "Высота полос."
L["The height of the title frame."] = "Высота заголовка окна."
L["The height of the window. If this is 0 the height is dynamically changed according to how many bars exist."] = "Высота окна. Если значение высоты равно 0, то она будет изменяться в соответствии с количеством существующих полос."
L["The margin between the outer edge and the background texture."] = "Расстояние между наружным краем и текстурой фона."
...
L["The texture used by all bars."] = "Текстура, используемая для полос."
...
L["The width of the bars."] = "Ширина полос."
L["Theme"] = "Тема"
...
L["This determines what other frames will be in front of the frame."] = "Это определяет, какие другие фреймы будут перед этим окном."
...
L["Tooltip position"] = "Положение подсказки"
...
L["Use class icons where applicable."] = "Использовать иконки класса, когда это возможно."
L["Use focus target"] = "Использовать цель фокуса"
L["Use role icons where applicable."] = "Использовать иконки ролей, когда это возможно."
L["Use spell school colors where applicable."] = "Использовать цвет школы заклинания, когда это возможно."
L["Various tweaks to get around deficiences and problems in the game's combat logs. Carries a small performance penalty."] = "Различные хитрости, чтобы обойти недостатки и проблемы в боевых логах игры. Вызывает небольшое снижение производительности."
L["Version History"] = "История версий"
L["View the version history of Skada."] = "Просмотр истории версий Skada."
