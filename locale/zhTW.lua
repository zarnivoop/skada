...
L["Data text"] = "數據文本"
L["Data text acts as an LDB data feed. It can be integrated in any LDB display such as Titan Panel or ChocolateBar. It also has an optional internal frame."] = "數據文本作為LDB數據源。可整合到任何LDB顯示插件中，如Titan Panel或ChocolateBar。還有可選的內部框架。"
L["Death log"] = "死亡記錄"
L["Deaths"] = "死亡紀錄"
L["Deaths:"] = "死亡人數:"
...
L["Hide line numbers"] = "隱藏行號"
L["Hide rank numbers on bars."] = "隱藏條形圖上的排名數字。"
L["Hide when solo"] = "單獨時隱藏"
L["Hide window"] = "隱藏視窗"
...
L["Hint: Left-Click to set active mode."] = "提示：左鍵點擊設置活動模式"
...
L["Right-click to set active set."] = "右鍵點擊設置活動數據集"
L["Role icons"] = "角色類型圖標"
...
L["Version History"] = "版本歷史"
L["View the version history of Skada."] = "查看Skada的版本歷史。"
L["Show Version History"] = "顯示版本歷史"
L["Display the version history using the notification system."] = "使用通知系統顯示版本歷史。"
L["When possible, bar text will be colored according to player class."] = "可能時，文本將根據玩家職業著色"
L["When possible, bars will be colored according to player class."] = "可能時，計量條將根據玩家職業著色"
...
L["Right-click to set active set."] = "右鍵點擊設置活動數據集"
L["Shift + Left-Click to open menu."] = "Shift + 左鍵點擊開啟選單"
L["Class color text"] = "職業顏色文本"
L["When possible, bar text will be colored according to player class."] = "可能時，文本將根據玩家職業著色"
L["Text color"] = "文本顏色"
L["Choose the default color."] = "選擇預設顏色"
L["Font flags"] = "字體標誌"
L["Sets the font flags."] = "設置字體標誌"
L["None"] = "無"
L["Outline"] = "輪廓"
L["Thick outline"] = "粗體"
L["Monochrome"] = "單色"
L["Outlined monochrome"] = "帶輪廓的單色"
L["Death log"] = "死亡記錄"
L["Show death log"] = "顯示死亡記錄"
L["Time relative to fight start."] = "相對戰鬥開始的時間"
L["Hide in PvP"] = "在PvP中隱藏"
L["Hide line numbers"] = "隱藏行號"
L["Hide rank numbers on bars."] = "隱藏條形圖上的排名數字。"
L["Hide when solo"] = "單獨時隱藏"
