...
L["Hide line numbers"] = "줄 번호 숨기기"
L["Hide rank numbers on bars."] = "바에서 순위 번호 숨기기."
...
L["Version History"] = "버전 기록"
L["View the version history of Skada."] = "Skada의 버전 기록을 봅니다."
L["Show Version History"] = "버전 기록 표시"
L["Display the version history using the notification system."] = "알림 시스템을 사용하여 버전 기록을 표시합니다."
...
-- Broker Display
L["Data text"] = "데이터 문자"
L["Data text acts as an LDB data feed. It can be integrated in any LDB display such as Titan Panel or ChocolateBar. It also has an optional internal frame."] = "데이터 문자는 LDB 데이터 피드로 작동합니다. Titan Panel이나 ChocolateBar와 같은 모든 LDB 디스플레이에 통합될 수 있습니다. 또한 선택적 내부 프레임도 있습니다."
L["Hint: Left-Click to set active mode."] = "힌트: 왼쪽 클릭으로 활성 모드를 설정합니다."
L["Right-click to set active set."] = "오른쪽 클릭으로 활성 세트를 설정합니다."
L["Shift + Left-Click to open menu."] = "Shift + 왼쪽 클릭으로 메뉴를 엽니다."
L["Class color text"] = "직업 색상 문자"
L["When possible, bar text will be colored according to player class."] = "가능한 경우 플레이어 직업에 따라 바 문자가 색상화됩니다."
L["Text color"] = "문자 색상"
L["Choose the default color."] = "기본 색상을 선택하세요."
L["Font flags"] = "글꼴 플래그"
L["Sets the font flags."] = "글꼴 플래그를 설정합니다."
L["None"] = "없음"
L["Outline"] = "외곽선"
L["Thick outline"] = "두꺼운 외곽선"
L["Monochrome"] = "단색"
L["Outlined monochrome"] = "외곽선이 있는 단색"

-- Death Log
L["Death log"] = "죽음 기록"
L["Show death log"] = "죽음 기록 표시"
L["Time relative to fight start."] = "전투 시작 기준 시간."
