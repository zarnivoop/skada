...
L["Text"] = "Text"
L["Put values on new line."] = "Put values on new line."
L["New line:\nExac\n30.71M (102.1K)\n\nDivider:\nExac - 30.71M (102.7K)"] = "New line:\nExac\n30.71M (102.1K)\n\nDivider:\nExac - 30.71M (102.7K)"
L["Use class colors"] = "Use class colors"
L["Class colors:\n|cFFF58CBAExac|r - 30.71M (102.7K)\nWithout:\nExac - 30.71M (102.7K)"] = "Class colors:\n|cFFF58CBAExac|r - 30.71M (102.7K)\nWithout:\nExac - 30.71M (102.7K)"
L["Width of bars. This only applies if the 'Fixed bar width' option is used."] = "Width of bars. This only applies if the 'Fixed bar width' option is used."
L["Font Color"] = "Font Color"
L["Font Color. \nClick 'class color' to begin."] = "Font Color. \nClick 'class color' to begin."
L["Use ElvUI skin if avaliable."] = "Use ElvUI skin if available."
L["Check this to use ElvUI skin instead. \nDefault: checked"] = "Check this to use ElvUI skin instead. \nDefault: checked"
L["Use solid background."] = "Use solid background."
L["Un-check this for an opaque background."] = "Un-check this for an opaque background."
L["Spell details available after combat"] = "Spell details available after combat"
