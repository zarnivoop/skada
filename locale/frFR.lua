...
L["Broker display"] = "Affichage Broker"
...
L["Energy gain sources"] = "Sources des gains d'énergie"
L["Energy gained"] = "Énergie obtenue"
...
L["Focus gain sources"] = "Sources des gains de focalisation"
L["Focus gained"] = "Focalisation obtenue"
...
L["Missed"] = "Raté"
L["Mode"] = "Mode"
L["Mode description"] = "Passe à un mode spécifique."
...
L["Power"] = "Puissance"
L["Power gains"] = "Gains de puissance"
L["Profiles"] = "Profils"
L["Rage gain sources"] = "Sources des gains de rage"
L["Rage gained"] = "Rage obtenue"
L["Raid"] = "Raid"
L["RDPS"] = "RDPS"
L["RealID"] = "RealID"
L["Reflect"] = "Renvoie"
...
L["Runic power gain sources"] = "Sources des gains de puissance runique"
L["Runic power gained"] = "Puissance runique obtenue"
L["'s "] = " : "
...
L["Scale"] = "Échelle"
L["Segment"] = "Segment"
L["Segment description"] = "Passe à un segment spécifique."
...
L["Use spell school colors where applicable."] = "Utilise les couleurs des écoles de magie quand cela est possible."
L["Various tweaks to get around deficiences and problems in the game's combat logs. Carries a small performance penalty."] = "Divers ajustements afin de contourner les manques et problèmes du journal de combat du jeu. Affecte légèrement les performances."
L["Version History"] = "Historique des versions"
L["View the version history of Skada."] = "Afficher l'historique des versions de Skada."
L["Show Version History"] = "Afficher l'historique des versions"
L["Display the version history using the notification system."] = "Afficher l'historique des versions en utilisant le système de notification."
...
-- Broker Display
L["Data text"] = "Texte de données"
L["Data text acts as an LDB data feed. It can be integrated in any LDB display such as Titan Panel or ChocolateBar. It also has an optional internal frame."] = "Le texte de données agit comme un flux de données LDB. Il peut être intégré dans n'importe quel affichage LDB tel que Titan Panel ou ChocolateBar. Il dispose également d'un cadre interne optionnel."
L["Hint: Left-Click to set active mode."] = "Astuce : Clic gauche pour définir le mode actif."
L["Right-click to set active set."] = "Clic droit pour définir l'ensemble actif."
L["Shift + Left-Click to open menu."] = "Maj + Clic gauche pour ouvrir le menu."
L["Class color text"] = "Texte coloré par classe"
L["When possible, bar text will be colored according to player class."] = "Lorsque possible, le texte sera coloré selon la classe du joueur."
L["Text color"] = "Couleur du texte"
L["Choose the default color."] = "Choisir la couleur par défaut."
L["Font flags"] = "Options de police"
L["Sets the font flags."] = "Définit les options de police."
L["None"] = "Aucun"
L["Outline"] = "Contour"
L["Thick outline"] = "Contour épais"
L["Monochrome"] = "Monochrome"
L["Outlined monochrome"] = "Monochrome avec contour"

-- Death Log
L["Death log"] = "Journal des morts"
L["Show death log"] = "Afficher le journal des morts"
L["Time relative to fight start."] = "Temps relatif au début du combat."

-- Particle Display
L["Particle Display"] = "Affichage de particules"
L["Options for the particle display."] = "Options pour l'affichage de particules."
L["Particle display settings."] = "Paramètres d'affichage de particules."
L["Particle Density"] = "Densité de particules"
L["Adjusts the number of particles shown."] = "Ajuste le nombre de particules affichées."
L["Particle Speed"] = "Vitesse des particules"
L["Adjusts the speed of the particles."] = "Ajuste la vitesse des particules."
L["Particle Size"] = "Taille des particules"
L["Adjusts the size of the particles."] = "Ajuste la taille des particules."
L["Particle Spacing"] = "Espacement des particules"
L["Adjusts the spacing between particles."] = "Ajuste l'espacement entre les particules."
L["Visual Effects"] = "Effets visuels"
L["Spell Effects"] = "Effets de sorts"
L["Show spell effects on particles."] = "Afficher les effets de sorts sur les particules."
L["Critical Effects"] = "Effets critiques"
L["Show critical hit effects on particles."] = "Afficher les effets de coups critiques sur les particules."
L["Fade Particles"] = "Estomper les particules"
L["Fade particles as they reach the end of their path."] = "Estomper les particules lorsqu'elles atteignent la fin de leur trajectoire."
L["Color Options"] = "Options de couleur"
L["Use Class Colors"] = "Utiliser les couleurs de classe"
L["Color particles based on player class."] = "Colorer les particules en fonction de la classe du joueur."
L["Custom Color"] = "Couleur personnalisée"
L["Set a custom color for particles when not using class colors."] = "Définir une couleur personnalisée pour les particules lorsque les couleurs de classe ne sont pas utilisées."

-- Window Creation
L["Create Windows"] = "Créer des fenêtres"
L["Create bar window"] = "Créer une fenêtre de barres"
L["Enter the name for the new bar display window."] = "Entrez le nom de la nouvelle fenêtre d'affichage de barres."
L["Create inline window"] = "Créer une fenêtre en ligne"
L["Enter the name for the new inline display window."] = "Entrez le nom de la nouvelle fenêtre d'affichage en ligne."
L["Create broker window"] = "Créer une fenêtre broker"
L["Enter the name for the new broker display window."] = "Entrez le nom de la nouvelle fenêtre d'affichage broker."
L["Create particle window"] = "Créer une fenêtre de particules"
L["Enter the name for the new particle display window."] = "Entrez le nom de la nouvelle fenêtre d'affichage de particules."
L["Enter the name for the new window with the selected display system."] = "Entrez le nom de la nouvelle fenêtre avec le système d'affichage sélectionné."
